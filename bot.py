...
async def people(ctx, *, search:str=None):
    ...
    if search == 'Luke Skywalker':
        ...
        ssearch.add_field(name='Name',value=str(json['name']))
        ssearch.add_field(name='Height',value=str(json['height']) + ' centimetres.')
        ssearch.add_field(name='Weight',value=str(json['mass']) + ' kilograms.' )
        ssearch.add_field(name='Hair Color',value=str(json['hair_color']))
        ssearch.add_field(name='Skin Color',value=str(json['skin_color']))
        ssearch.add_field(name='Eye Color',value=str(json['eye_color']))
        ssearch.add_field(name='Birth Year',value=str(json['birth_year']))
